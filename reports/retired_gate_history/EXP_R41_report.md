# EXP_R41 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885471744 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R42 is the next bounded audit.
