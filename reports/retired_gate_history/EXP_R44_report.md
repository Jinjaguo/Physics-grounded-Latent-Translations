# EXP_R44 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885443072 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R45 is the next bounded audit.
