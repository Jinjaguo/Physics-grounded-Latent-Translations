# EXP_R43 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885451264 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R44 is the next bounded audit.
