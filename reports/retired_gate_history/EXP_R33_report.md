# EXP_R33 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885541376 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R34 is the next bounded audit.
