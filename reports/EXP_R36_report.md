# EXP_R36 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885512704 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R37 is the next bounded audit.
