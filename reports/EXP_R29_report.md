# EXP_R29 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885574144 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R30 is the next bounded audit.
