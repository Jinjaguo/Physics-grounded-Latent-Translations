# EXP_R42 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885459456 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R43 is the next bounded audit.
