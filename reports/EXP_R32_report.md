# EXP_R32 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885549568 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R33 is the next bounded audit.
