# EXP_R18 report — interface-gated continuation
...
## Concrete evidence
- Disk audit: available bytes=911885668352 (floor=300000000000, passed=True).
...
## Decision
`SUCCESS=false`; EXP_R19 is the next bounded audit.
